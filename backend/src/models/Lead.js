...
const leadSchema = new mongoose.Schema({
  ...
  closedAt: {
    type: Date, // The date when the lead was closed (optional, used when status is "Closed") means jab lead close ho jaye tab ye field set hoga
  },
});

// Middleware to update the `updatedAt` field on each save matlab jab bhi lead save hoga ye field update ho jayega
